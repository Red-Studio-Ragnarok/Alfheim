...
@Mod(modid = ID, version = VERSION, updateJSON = "https://forge.curseupdate.com/910715/alfheim", useMetadata = true, dependencies = "required-after:mixinbooter@[8.6,);required-after:redcore@[0.5,)")
